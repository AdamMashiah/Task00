...
public final class JavmosGUI {
    ...
    private final JTextField equationField = new JTextField("");
    ...
    private final DrawListener drawListener = new DrawListener(this, javmosPanel, null);
    ...
    private JPanel createControlPanel() {
        ...
        configureComponent(equationField, CONTROL_PANEL_WIDTH, CONTROL_PANEL_HEIGHT / CONTROL_PANEL_ITEMS, Color.WHITE, 20, drawListener, "", Color.LIGHT_GRAY, Color.MAGENTA);
